...
type tokenclass = TextBeginT | SeparatorT | KeyWordT | OpT | NumT (*��� ������ �����; �����������; �������� �����; ��������� �����*)
 | CharT | StringT (*���� ; ������*)
 | NameT | CapNameT | PunctT | CommentT | TailCommentT (*�����; ����� � ������� �����; ��������; ������� �����������; ���������*)
...
(*�������� ����� http://caml.inria.fr/pub/docs/manual-ocaml-312/manual044.html *)
let ocaml_keywords = [
	"and"; "as"; "assert"; 
	"begin"; 
	"class"; "constraint"; 
